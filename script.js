...
//sons
var somDisparo=document.getElementById("somScore");
var somScore=document.getElementById("somDisparo");
var somGameOver=document.getElementById("somGameOver");

document.getElementById("correntScore").innerHTML = 0;//sua pontuação
document.getElementById("totalScore").innerHTML = 0;//melhor pontuação
